...
public class CrimeListFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_show_subtitle:
                mSubtitleVidible = !mSubtitleVidible;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mSubtitleVidible = savedInstanceState.getBoolean(SAVED_SUBTITLE_VISIBLE);}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(SAVED_SUBTITLE_VISIBLE, mSubtitleVidible);
    }
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            mChangeId = (CrimeLab.get(getActivity()).getCrimes()).indexOf(mCrime);
            startActivity(intent);
        }
    }
